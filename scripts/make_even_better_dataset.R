## Make_even_beter_dataset.R changes

# Load necessary library
library(readr)
library(dplyr)

# Helper function to validate the "to" column values
# This function checks if the "to" column values are valid
...
# Helper function to validate the "user" column values
# This function checks if the "user" column values are valid
...
# Helper function to validate the other columns
# This function checks if the "task_pos", "task_conf", "rel_pos", "rel_conf", "3rdVero" columns are valid
...
# Helper function to check for trailing commas or commas followed by spaces
# This function checks if there are trailing commas or commas followed by spaces
...
# Helper function to standardize column values
# This function standardizes column values by removing spaces and converting "all" to lowercase
...
# This function reads the dataset, validates and cleans it based on the specified rules, and then standardizes the output
...
# Enter your csv file address below
file_path <- "/Users/haiqili/Desktop/SONIC/STRONG/Week 7 Assignments/02_25_2021_vero #7_task+team_round 3_otter.ai.csv"
...
# Output the csv file in perfect format. Feel free to change the output file name and address
write_csv(cleaned_dataset,"/Users/haiqili/Desktop/SONIC/STRONG/Week 7 Assignments/cleaned_data/cleaned_1.csv")
